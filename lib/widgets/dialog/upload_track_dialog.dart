...
class UploadTrackDialog extends StatefulWidget {
  const UploadTrackDialog(
      {super.key, required this.file, required this.album, this.onDone});
...
class _UploadTrackDialogState extends State<UploadTrackDialog> {
  ...
  void _handleUpload() async {
    ...
    final t = await v.uploadTrack(widget.file, widget.album,
        title: title.isEmpty ? widget.file.name : title);
